...
<body>
        ...
        <?php 
         ...
         ?>
        <!-- <button class="button_new" 
        onclick="location.href='edit.php?varname=<?php echo $row['user_name'] ?>'">Edit</button> -->
        ...
        <?php
         ...
         onclick="location.href='edit-admin.php?varname=<?php echo $un ?>'">Edit</button>
