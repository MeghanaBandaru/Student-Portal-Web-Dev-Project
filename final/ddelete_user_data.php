...
<body>
        ...
        <fieldset>
           <p> Are you sure to delete <?php echo $row['user_name']; ?></p> 
        ...
        <?php
         ...
         ?>
         <button class="button" type="submit" id="" style=" background-color:#ff3333;"
         onclick="location.href='ddelete.php?varname=<?php echo $current_user ?>'">Delete</button>
